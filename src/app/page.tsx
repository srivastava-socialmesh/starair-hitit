...
import LatestFareSheet from "@/components/sections/LatestFareSheet";
        ...
        <div className="max-w-full mx-auto px-4 sm:px-8 lg:px-16 xl:px-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/group-booking" className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-accent transition hover:shadow-md">
              ...
              <span className="inline-block mt-4 text-accent group-hover:translate-x-1 transition">Learn More →</span>
            </Link>
            <Link href="/cargo" className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-accent transition hover:shadow-md">
              <div className="text-4xl mb-3">📦</div>
            ...
            <Link href="/charter" className="group bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 hover:border-accent transition hover:shadow-md">
