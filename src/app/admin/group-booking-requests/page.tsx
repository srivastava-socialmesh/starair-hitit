...
export default async function GroupBookingRequestsPage() {
    ...
    <AdminLayout>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-amber-400">Group Booking Requests</h1>
            <p className="text-slate-400 text-sm">Manage all group booking requests</p>
          </div>
        ...
        {error ? (
          ...
          <div className="bg-[#111827] border border-white/10 p-8 rounded-xl text-center text-slate-400">
            No group booking requests received yet.
          </div>
        ) : (
