          ...
          {products.map((product) => {
            ...
            return (
              <SwiperSlide key={product.id}>
                <div
                  className="group relative rounded-2xl overflow-hidden h-[420px] cursor-pointer shadow-lg bg-white border border-gray-200 hover:border-accent transition duration-300"
                ...
                >
                  ...
                  >
                    <div className="p-5 pt-8">
                      ...
                      {product.link && (
                        <a href={product.link} className="mt-4 inline-block bg-accent hover:bg-[#b00226] text-white font-bold py-2 px-6 rounded-full text-sm transition">
                          Learn More
                        </a>
                      )}
                    </div>
