...
const bannerImages = [
  "https://images.unsplash.com/photo-1542296332-2e4473faf563?w=1920&h=1080&fit=crop&crop=center", // Replace with your Supabase URL once it works
];
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[100svh] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full min-h-[100svh] grid grid-cols-1 lg:grid-cols-2 items-center gap-20 px-8 pt-28 pb-12">
        <motion.div
