...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto min-h-[100svh] grid grid-cols-1 lg:grid-cols-2 items-start gap-6 sm:gap-8 lg:gap-10 px-4 sm:px-6 lg:px-8 pt-18 sm:pt-20 lg:pt-18 pb-8 min-w-0">
        <motion.div
          initial={{ opacity: 0, x: -30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          className="flex flex-col justify-start items-start text-left space-y-3 sm:space-y-4 pt-8 sm:pt-12 w-full min-w-0 overflow-hidden"
        >
