...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-rose-400 to-transparent z-10"></div>
      ...
      <div className="relative z-10 w-full min-h-[100svh] grid grid-cols-1 lg:grid-cols-2 items-start gap-6 sm:gap-8 lg:gap-12 px-4 sm:px-8 lg:px-16 xl:px-24 pt-20 sm:pt-24 lg:pt-20 pb-8 max-w-[1600px] mx-auto">
        ...
        >
          <h1 className="w-full text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-[1.1] tracking-tight text-gray-900">
            <span className="drop-shadow-sm block text-left">Discover the</span>
            <span className="text-rose-500 drop-shadow-sm block text-right">Art of Travel</span>
          </h1>
          <p className="text-gray-700 text-sm sm:text-sm max-w-xl leading-6">
            Experience luxury at 35,000 feet. Real-time global inventory powered by Hitit middleware.
          </p>
          <div className="flex flex-wrap gap-4 sm:gap-6 text-[10px] sm:text-[11px] text-gray-600 uppercase tracking-wider">
