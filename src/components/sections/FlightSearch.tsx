          ...
          <form onSubmit={handleSearch} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-black/20 backdrop-blur-sm border border-white/20 rounded-xl pl-10 pr-4 py-3 text-white placeholder:text-white/50 focus:border-red-500 outline-none transition"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-black/20 backdrop-blur-sm border border-white/20 rounded-xl pl-10 pr-4 py-3 text-white [color-scheme:dark] focus:border-red-500 outline-none transition"
                    required
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex items-center bg-black/20 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-2">
                  <button
                    type="button"
        ...
        {primaryTab === 'checkin' && (
          <form onSubmit={handleCheckin} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/20 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-3 text-white placeholder:text-white/50 focus:border-red-500 outline-none transition"
                  required
                />
              </div>
              <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-red-500/30 flex items-center justify-center gap-2 transition-all hover:scale-[1.02] disabled:opacity-70"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/20 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-3 text-white [color-scheme:dark] focus:border-red-500 outline-none transition"
                  required
                />
              </div>
            </div>
