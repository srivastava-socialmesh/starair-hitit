            ...
            <SwiperSlide key={deal.id}>
              <div className="group relative rounded-2xl overflow-hidden h-96 shadow-2xl bg-slate-800 border border-white/5 hover:border-rose-500/30 transition duration-300">
                ...
                <div className="absolute top-4 right-4 z-20">
                  <span className="bg-rose-600 text-white px-3 py-1.5 rounded-full text-sm font-bold shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 p-6 z-20 w-full">
                  ...
                  <button className="mt-4 px-5 py-2 bg-rose-600 hover:bg-rose-700 rounded-full text-white text-sm font-semibold shadow-lg shadow-rose-500/30 transition">
                    Learn More →
                  </button>
                </div>
