...
import { Plane, Clock, Ticket, MapPin, Phone, Award, User } from "lucide-react";
...
const actions = [
  ...
  { icon: MapPin, label: "Check Itineraries", href: "/itinerary" },
  { icon: Phone, label: "Contact Us", href: "/contact" },
  { icon: Award, label: "LifeMiles", href: "/loyalty" },
  { icon: User, label: "Frequent Flyer", href: "/frequent-flyer" },
];

export default function QuickActions() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 -mt-8 relative z-20">
      <div className="glass rounded-2xl border border-white/10 p-4 shadow-lg">
